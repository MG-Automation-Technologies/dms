        ...
        public void ImportMail()
        {
            ...
            foreach (Outlook.Explorer openWindow in this.Application.Explorers)
            {
                ...
                try
                {
                    ...
                    foreach (Object selObject in openWindow.Selection)
                    {
                        if (selObject is Outlook.MailItem)
                        {
                            ...
                            newMail.from = mailItem.SenderEmailAddress;
                            ...
                            if (mailItem.BodyFormat.Equals(Outlook.OlBodyFormat.olFormatPlain))
                            {
