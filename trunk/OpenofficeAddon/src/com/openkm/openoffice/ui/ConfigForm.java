...
public class ConfigForm extends javax.swing.JFrame {
    ...
    private void acceptButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_acceptButtonActionPerformed
        ...
        if (configBean.getHost().equals("")) {
            JOptionPane.showMessageDialog(null,"Host must not be empty","Error", JOptionPane.ERROR_MESSAGE);
        } else if (configBean.getUser().equals("")) {
            JOptionPane.showMessageDialog(null,"User must not be empty","Error", JOptionPane.ERROR_MESSAGE);
