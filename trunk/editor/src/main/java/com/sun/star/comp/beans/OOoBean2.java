		...
		java.io.Externalizable
{
	 ...
	 */
	public OOoBean2( OfficeConnection iConnection )
		throws NoConnectionException
	{
	...
	/** This method causes the office window to be displayed.
	    ...
	    @throws NoConnectionException
	    	if the connection is not established.
	 */
	public synchronized void aquireSystemWindow()throws 
			...
			while ( !bLoaded )
			{
				...
				try
				{
					...
					if ( xFrameWindow == null )
					{
						...
						xFrameWindow = getOOoConnection().createOfficeWindow(OOoBean2.this);
