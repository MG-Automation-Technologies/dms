...
public class Lang_pt_PT {
	...
	public final static HashMap<String, String> lang;
	  static {
	    ...
	    lang.put("OKM-"+ErrorCode.ORIGIN_OKMAuthServlet+ErrorCode.CAUSE_AccessDenied, "Sem permissão para aceder");
	    lang.put("OKM-"+ErrorCode.ORIGIN_OKMAuthServlet+ErrorCode.CAUSE_ItemNotFound, "Não existe um elemento com o nome especificado");
