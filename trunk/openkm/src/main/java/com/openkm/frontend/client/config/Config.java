...
public class Config {
	...
	public static final String OKMChatService = "/OpenKM"+INSTALL+"/OKMChatServlet";
	...
	public static final String OKMStaplingService = "/OpenKM"+INSTALL+"/extension/OKMStaplingServlet";
	public static final String OKMDownloadStaplingService = "/OpenKM"+INSTALL+"/extension/StapleDownload";
}
