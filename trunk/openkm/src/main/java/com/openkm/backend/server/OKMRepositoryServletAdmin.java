...
public class OKMRepositoryServletAdmin extends OKMRemoteServiceServletAdmin implements OKMRepositoryService {
	...
	/* (non-Javadoc)
	 * @see com.openkm.backend.client.service.OKMRepositoryService#getTemplate()
	 */
	...
	/* (non-Javadoc)
	 * @see com.openkm.backend.client.service.OKMRepositoryService#getRoot()
	 */
	...
	/* (non-Javadoc)
	 * @see com.openkm.backend.client.service.OKMRepositoryService#getUuid()
	 */
	...
	/* (non-Javadoc)
	 * @see com.openkm.backend.client.service.OKMRepositoryService#getAppVersion()
	 */
