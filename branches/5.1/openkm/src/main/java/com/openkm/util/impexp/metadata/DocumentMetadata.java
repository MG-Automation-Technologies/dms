...
public class DocumentMetadata {
	...
	private Map<String, Byte> grantedUsers = new HashMap<String, Byte>();
	private Map<String, Byte> grantedRoles = new HashMap<String, Byte>();
	...
	public Map<String, Byte> getGrantedUsers() {
		return grantedUsers;
	}
	
	public void setGrantedUsers(Map<String, Byte> grantedUsers) {
		this.grantedUsers = grantedUsers;
	}
	
	public Map<String, Byte> getGrantedRoles() {
		return grantedRoles;
	}
	
	public void setGrantedRoles(Map<String, Byte> grantedRoles) {
