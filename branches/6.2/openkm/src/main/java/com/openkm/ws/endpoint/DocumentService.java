...
public class DocumentService {
	...
	@WebMethod
	public Document[] getChildren(@WebParam(name = "token") String token,
			@WebParam(name = "fldPath") String fldPath) throws RepositoryException, PathNotFoundException,
			DatabaseException {
	...
	public Version checkin(@WebParam(name = "token") String token,
			...
			@WebParam(name = "comment") String comment) throws FileSizeExceededException,
			UserQuotaExceededException, VirusDetectedException, LockException, VersionException,
	...
	@WebMethod
	public LockInfo lock(@WebParam(name = "token") String token,
	...
	public void purge(@WebParam(name = "token") String token,
			@WebParam(name = "docPath") String docPath) throws LockException, AccessDeniedException,
	...
	public void restoreVersion(@WebParam(name = "token") String token,
			...
			PathNotFoundException, LockException, RepositoryException, DatabaseException, ExtensionException {
	...
	public void purgeVersionHistory(@WebParam(name = "token") String token,
			@WebParam(name = "docPath") String docPath) throws AccessDeniedException, PathNotFoundException, 
