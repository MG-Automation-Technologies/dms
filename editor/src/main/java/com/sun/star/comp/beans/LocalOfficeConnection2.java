 ...
 * @since OOo 2.0.0
 */
public class LocalOfficeConnection2
	implements OfficeConnection
{
	...
	static
	{
		...
		if ( System.getProperty( "os.name" ).startsWith( "Windows" ) )
		{
			try 
			{
				System.out.println("carregant llibreria: msvcr70 init");
				NativeLibraryLoader.loadLibrary(LocalOfficeConnection2.class.getClassLoader(), "msvcr70");
				System.out.println("carregant llibreria: msvcr70 fi");
			} 
			catch (Throwable e)
			{
			...
			try 
			{
				System.out.println("carregant llibreria: msvcr71 init");
				NativeLibraryLoader.loadLibrary(LocalOfficeConnection2.class.getClassLoader(), "msvcr71");
				System.out.println("carregant llibreria: msvcr71 fi");
			} 
			catch (Throwable e)
			{
				// loading twice would fail
			...
			try 
			{
				System.out.println("carregant llibreria: uwinapi init");
				NativeLibraryLoader.loadLibrary(LocalOfficeConnection2.class.getClassLoader(), "uwinapi");
				System.out.println("carregant llibreria: uwinapi fi");
			}	
			catch (Throwable e)
			{
				// loading twice would fail
			...
			try 
			{
				System.out.println("carregant llibreria: jawt init");
				NativeLibraryLoader.loadLibrary(LocalOfficeConnection2.class.getClassLoader(), "jawt");
				System.out.println("carregant llibreria: jawt fi");
			}	
			catch (Throwable e)
			{
				// loading twice would fail
...
//		System.load( aSharedLibName );
		System.out.println("carregant llibreria: officebean init");
		NativeLibraryLoader.loadLibrary( LocalOfficeConnection2.class.getClassLoader(), "officebean" );
		System.out.println("carregant llibreria: officebean fi");
	}
	...
	{	
		...
		try 
		{
			...
			System.out.println("estic aqui -2");
		}
	...
	static private String getProgramPath()
	{
		if (mProgramPath == null) 
		{
			...
			File path = NativeLibraryLoader.getResource(
				LocalOfficeConnection2.class.getClassLoader(), aExec);
			if (path != null) 
