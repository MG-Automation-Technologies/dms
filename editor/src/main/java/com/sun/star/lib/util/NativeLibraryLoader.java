...
public final class NativeLibraryLoader {
    ...
    public static void loadLibrary(ClassLoader loader, String libname) {
    	System.out.println("estic en el loadLibrary");
    	System.out.println("libname:" + libname);
    	System.out.println("path en el mapa:" + System.mapLibraryName(libname));
    ...
    public static File getResource(ClassLoader loader, String name) {
        ...
        System.out.println("se busca en las url del class loader");
        if (loader instanceof URLClassLoader) {
            URL[] urls = ((URLClassLoader) loader).getURLs();
            for (int i = 0; i < urls.length; ++i) {
            	System.out.println("se busca en las url del class loader: " + urls[i]);
        ...
        System.out.println("no localizado devuelve null y pega el casque");
        return null;
    }
