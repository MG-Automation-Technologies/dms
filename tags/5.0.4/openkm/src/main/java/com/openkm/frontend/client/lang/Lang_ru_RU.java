...
public class Lang_ru_RU {
	...
	public final static HashMap<String, String> lang;
	  static {
	    ...
	    lang.put("startup.categories", "Получаю корневой узел категорий");
	    lang.put("startup.thesaurus", "Получаю корневой узел тезаурусов");
	    ...
	    lang.put("startup.user.home", "Получаю раздел пользователя");
	    lang.put("startup.bookmarks", "Получаю закладки");
	    lang.put("startup.loading.taxonomy", "Загружаю классификатор");
	    lang.put("startup.loading.taxonomy.getting.folders", "Загружаю классификатор - получаю разделы");
	    ...
	    lang.put("startup.loading.taxonomy.getting.filebrowser.folders", "Загружаю классификатор - получаю разделы");
	    ...
	    lang.put("startup.loading.categories", "Загружаю категории");
	    lang.put("startup.loading.thesaurus", "Загружаю тезаурусы");
		...
		// http://www.proz.com/kudoz/english_to_russian/tech_engineering/585193-keep_alive.html
	    lang.put("startup.keep.alive", "Загружаю режим keep-alive");
	    ...
	    lang.put("leftpanel.label.categories", "Категории");
	    lang.put("leftpanel.label.thesaurus", "Тезаурусы");
	    ...
	    // Tree
	    lang.put("tree.menu.directory.create", "Создать раздел");
	    ...
	    lang.put("tree.status.refresh.create", "Создаю раздел");
	    lang.put("tree.status.refresh.delete", "Удаляю раздел");
	    lang.put("tree.status.refresh.rename", "Переименовываю раздел");
	    lang.put("tree.status.refresh.restore", "Восстанавливаю раздел");
	    lang.put("tree.status.refresh.purge", "Очищаю раздел");
	    lang.put("tree.status.refresh.get", "Обновляю раздел");
	    lang.put("tree.folder.new", "Новый раздел");
	    ...
	    lang.put("tree.status.refresh.get.root", "Обновляю корневой раздел");
	    lang.put("tree.status.refresh.get.keywords", "Обновляю ключевые слова");
	    ...
	    lang.put("tree.menu.directory.find.folder","Искать раздел");
	    ...
	    lang.put("trash.directory.select.label", "Выбрать целевой раздел");
	    ...
	    lang.put("general.menu.edit", "Редактировать");
			lang.put("general.menu.file.create.directory", "Создать раздел");
			...
			lang.put("general.menu.file.send.link", "Послать ссылку на документ");
			lang.put("general.menu.file.send.attachment", "Послать прикрепленный файл");
			...
			lang.put("general.menu.file.scanner", "Сканер");
			lang.put("general.menu.file.uploader", "Загрузка файлов");
	    lang.put("general.menu.tools", "Инструменты");
    		...
    		lang.put("general.menu.administration", "Показать панель администрирования");
    		lang.put("general.menu.tools.preferences", "Предпочтения");
    			lang.put("general.menu.tools.user.preferences", "Пользовательская конфигурация");
	    ...
	    lang.put("filebrowser.status.refresh.delete.folder", "Удалить раздел");
	    ...
	    lang.put("filebrowser.status.refresh.folder.rename", "Переименовываю раздел");
	    lang.put("filebrowser.status.refresh.document.purge", "Удаляю документ");
	    lang.put("filebrowser.status.refresh.folder.purge", "Удаляю раздел");
	    lang.put("filebrowser.status.refresh.folder.get", "Обновляю раздел");
	    ...
	    // File Upload
	    lang.put("fileupload.send", "Загрузить");
	    ...
	    lang.put("fileupload.status.move.folder", "Перемещаю раздел...");
	    lang.put("fileupload.status.copy.folder", "Копирую раздел...");
	    lang.put("fileupload.status.restore.folder", "Восстанавливаю раздел...");
	    lang.put("fileupload.status.create.from.template", "Создаю файл из шаблона...");
	    lang.put("fileupload.status.of", "из");
	    lang.put("fileupload.label.insert", "Добавить новый документ");
	    ...
	    lang.put("fileupload.label.users.to.notify",  "Получатели");
	    lang.put("fileupload.label.users",  "Пользователи");
	    lang.put("fileupload.label.groups.to.notify","Группы рассылки");
	    lang.put("fileupload.label.groups","Группы");
	    ...
	    lang.put("fileupload.label.notify.comment", "Текст сообщения");
	    ...
	    lang.put("fileupload.label.error.move.folder", "Ошибка перемещения раздел");
	    lang.put("fileupload.label.error.copy.folder", "Ошибка копирования раздел");
	    lang.put("fileupload.label.error.restore.folder", "Ошибка восстановления раздела");
	    lang.put("fileupload.label.error.create.from.template", "Ошибка создания файл из шаблона");
	    lang.put("fileupload.label.error.not.allowed.move.folder.child", "Не разрешено перемещать в исходный или дочерний раздел");
	    lang.put("fileupload.label.error.not.allowed.copy.same.folder", "Не разрешено перемещать в исходный раздел");
	    lang.put("fileupload.label.error.not.allowed.create.from.template.same.folder", "Не разрешено создавать файл в исходном разделе");
	    ...
	    lang.put("tab.document.status.set.categories", "Обновляю список категорий");
	    ...
	    lang.put("tab.document.preview", "Предпросмотр");
	    ...
	    lang.put("document.categories", "Категории");
	    ...
	    lang.put("folder.number.folders", "Разделы");
	    lang.put("folder.number.documents", "Документы");
	    lang.put("folder.number.mails", "Почтовые сообщения");
	    ...
	    lang.put("security.group.permission.read", "Чтение");
	    lang.put("security.group.permission.write", "Запись");
	    lang.put("security.group.permission.delete", "Удаление");
	    lang.put("security.group.permission.security", "Изменение прав");
	    lang.put("security.user.name", "Пользователь");
	    lang.put("security.user.permission.read", "Чтение");
	    lang.put("security.user.permission.write", "Запись");
	    lang.put("security.user.permission.delete", "Удаление");
	    lang.put("security.user.permission.security", "Изменение прав");
	    ...
	    lang.put("secutiry.filter.by.users","Фильтр пользователей");
	    lang.put("secutiry.filter.by.groups","Фильтр групп");
	    lang.put("security.status.updating","Обновление прав доступа");
	    
	    // Preview
	    lang.put("preview.unavailable", "Предпросмотр недоступен");
	    ...
	    lang.put("confirm.delete.folder", "Вы действительно хотите удалить раздел?");
	    ...
	    lang.put("confirm.purge.folder", "Вы действительно хотите удалить раздел?");
	    ...
	    lang.put("confirm.force.unlock", "Вы действительно хотите принудительно разблокировать документ ?");
	    lang.put("confirm.force.cancel.checkout", "Вы действительно хотите принудительно прервать процесс получения ?");
	    ...
	    lang.put("search.folder", "Раздел");
	    lang.put("search.category", "Категории");
	    ...
	    lang.put("search.type.folder", "Раздел");
	    ...
	    lang.put("search.save.as.news", "Сохранить результат поиска в виде новостей");

	    // search folder filter popup
	    lang.put("search.folder.filter", "Фильтровать по разделам");
	    lang.put("search.category.filter", "Фильтровать по категориям");
	    ...
	    lang.put("search.result.menu.go.folder", "Перейти к разделу");
	    ...
	    lang.put("button.update", "Актуализировать");
	    ...
	    lang.put("button.test", "Тест");
	    lang.put("button.next", "Далее");
	    ...
	    lang.put("bookmark.type.folder", "Раздел");
	    
	    // Notify
	    lang.put("notify.label", "Почтовое сообщение с ссылкой на документ");
	    lang.put("notify.label.attachment", "Почтовое сообщение с прикрепленным документом");
	    ...
	    lang.put("status.folder.copied", "Раздел помечен для копирования");
	    lang.put("status.folder.cut", "Раздел помечен для перемещения");
	    ...
	    lang.put("status.network.error.detected", "Зафиксированна сетевая ошибка");
	    ...
	    lang.put("dashboard.tab.keymap", "Облако ключевых слов");
	    ...
	    lang.put("dashboard.user.subscribed.folders", "Подписанные разделы");
	    ...
	    // Thesaurus
	    lang.put("thesaurus.directory.select.label", "Добавить ключевое слово");
	    lang.put("thesaurus.tab.tree", "Дерево");
	    lang.put("thesaurus.tab.keywords", "Ключевые слова");
	    
	    // Categories
	    lang.put("categories.folder.select.label", "Добавить категорию");
	    lang.put("categories.folder.error.delete", "Невозможно удалить категорию, содержащую документы");
	    
	    // Wizard
	    lang.put("wizard.document.uploading", "Мастер добавления документа");
	    ...
	    lang.put("OKM-"+ErrorCode.ORIGIN_OKMFolderService+ErrorCode.CAUSE_AccessDenied, "Доступ к разделу запрещен");
	    lang.put("OKM-"+ErrorCode.ORIGIN_OKMFolderService+ErrorCode.CAUSE_ItemNotFound, "Раздел не найден");
	    lang.put("OKM-"+ErrorCode.ORIGIN_OKMFolderService+ErrorCode.CAUSE_ItemExists, "Раздел уже существует");
	    ...
	    lang.put("OKM-"+ErrorCode.ORIGIN_OKMFolderService+ErrorCode.CAUSE_PathNotFound, "Путь к разделу не найден");
	    lang.put("OKM-"+ErrorCode.ORIGIN_OKMFolderService+ErrorCode.CAUSE_DatabaseException, "Ошибка базы данных");

	    lang.put("OKM-"+ErrorCode.ORIGIN_OKMAuthService+ErrorCode.CAUSE_AccessDenied, "Доступ к объекту запрещен");
	    lang.put("OKM-"+ErrorCode.ORIGIN_OKMAuthService+ErrorCode.CAUSE_ItemNotFound, "Объект не найден");
	    lang.put("OKM-"+ErrorCode.ORIGIN_OKMAuthService+ErrorCode.CAUSE_Repository, "Внутренняя ошибка репозитория");
	    lang.put("OKM-"+ErrorCode.ORIGIN_OKMAuthService+ErrorCode.CAUSE_General, "Внутренняя ошибка репозитория");
	    lang.put("OKM-"+ErrorCode.ORIGIN_OKMAuthService+ErrorCode.CAUSE_DatabaseException, "Ошибка базы данных");
	    ...
	    lang.put("OKM-"+ErrorCode.ORIGIN_OKMUploadService+ErrorCode.CAUSE_DocumentNameMismatch, "Несовпадение в имени документа");
	    
	    lang.put("OKM-"+ErrorCode.ORIGIN_OKMDownloadService+ErrorCode.CAUSE_Repository, "Сессия закрыта");
	    lang.put("OKM-"+ErrorCode.ORIGIN_OKMDownloadService+ErrorCode.CAUSE_DatabaseException, "Ошибка базы данных");
	    ...
	    lang.put("OKM-"+ErrorCode.ORIGIN_OKMSearchService+ErrorCode.CAUSE_DatabaseException, "Ошибка базы данных");
	    ...
	    lang.put("OKM-"+ErrorCode.ORIGIN_OKMDashboardService+ErrorCode.CAUSE_DatabaseException, "Ошибка базы данных");
	    
	    lang.put("OKM-"+ErrorCode.ORIGIN_OKMWorkspaceService+ErrorCode.CAUSE_Repository, "Внутренняя ошибка репозитория");
	    lang.put("OKM-"+ErrorCode.ORIGIN_OKMWorkspaceService+ErrorCode.CAUSE_IOException, "Ошибка ввода/вывода");
	    
	    lang.put("OKM-"+ErrorCode.ORIGIN_OKMWorkflowService+ErrorCode.CAUSE_Repository, "Внутренняя ошибка репозитория");
	    lang.put("OKM-"+ErrorCode.ORIGIN_OKMWorkflowService+ErrorCode.CAUSE_DatabaseException, "Ошибка базы данных");
	    ...
	    lang.put("OKM-"+ErrorCode.ORIGIN_OKMMailService+ErrorCode.CAUSE_DatabaseException, "Ошибка базы данных");
	    ...
	    lang.put("OKM-"+ErrorCode.ORIGIN_OKMNotifyService+ErrorCode.CAUSE_DatabaseException, "Ошибка базы данных");
	    ...
	    lang.put("OKM-"+ErrorCode.ORIGIN_OKMPropertyGroupService+ErrorCode.CAUSE_DatabaseException, "Ошибка базы данных");
	    ...
	    lang.put("OKM-"+ErrorCode.ORIGIN_OKMPropertyGroupService+ErrorCode.CAUSE_IOException, "Ошибка ввода/вывода");
	    ...
	    lang.put("OKM-"+ErrorCode.ORIGIN_OKMRepositoryService+ErrorCode.CAUSE_DatabaseException, "Ошибка базы данных");
	    ...
	    lang.put("OKM-"+ErrorCode.ORIGIN_OKMUserCopyService+ErrorCode.CAUSE_DatabaseException, "Ошибка базы данных");
	  }
}