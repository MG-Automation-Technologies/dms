 ...
 *
 */
public class OKMTestServlet extends OKMRemoteServiceServlet implements OKMTestService {
	private static final long serialVersionUID = 5955080308631192466L;
	private static Logger log = LoggerFactory.getLogger(OKMTestServlet.class);
	...
	public List<GWTFolder> folderText(int size) {
		...
		for (int i = 0; i<size; i++) {
			...
			folder.setUuid("uuid");
			folder.setSubscriptors(new ArrayList<String>());
