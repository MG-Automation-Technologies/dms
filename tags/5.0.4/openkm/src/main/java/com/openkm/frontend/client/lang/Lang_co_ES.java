...
public class Lang_co_ES {
	...
	public final static HashMap<String, String> lang;
	  static {
	    ...
	    lang.put("startup.categories", "Obteniendo el nodo principald de las categorías");
	    lang.put("startup.thesaurus", "Obteniendo el nodo principal del thesaurus");
	    ...
	    lang.put("tree.menu.export", "Exportar a archivo");
	    ...
	    lang.put("general.menu.tools", "Herramientas");
    		...
    		lang.put("general.menu.tools.preferences", "Preferencias");
	    ...
	    lang.put("general.menu.help", "Ayuda");
		    lang.put("general.menu.bug.report", "Reporte de errores");
	    ...
	    lang.put("filebrowser.menu.start.workflow", "Iniciar flujo");
	    ...
	    lang.put("fileupload.status.sending", "Subiendo el archivo...");
	    lang.put("fileupload.status.indexing", "Indexando el archivo...");
	    ...
	    lang.put("fileupload.button.add.other.file", "Añadir otro archivo");
	    lang.put("fileupload.status.move.file", "Moviendo el archivo...");
	    lang.put("fileupload.status.move.mail", "Moviendo el correo electrónico...");
	    lang.put("fileupload.status.copy.file", "Copiando el archivo...");
	    lang.put("fileupload.status.copy.mail", "Copiando el correo electrónico...");
	    lang.put("fileupload.status.restore.file", "Restaurando el archivo...");
	    ...
	    lang.put("fileupload.status.create.from.template", "Creando el archivo desde la plantilla...");
	    ...
	    lang.put("fileupload.label.error.importing.zip", "Error al importar el archivo");
	    lang.put("fileupload.label.error.move.file", "Error moviendo el archivo");
	    lang.put("fileupload.label.error.move.mail", "Error moviendo el correo electrónico");
	    lang.put("fileupload.label.error.copy.file", "Error copiando el archivo");
	    lang.put("fileupload.label.error.copy.mail", "Error copiando el correo electrónico");
	    lang.put("fileupload.label.error.restore.file", "Error restaurando el archivo");
	    ...
	    lang.put("fileupload.label.error.create.from.template", "Error creando archivo desde la plantilla");
	    ...
	    lang.put("fileupload.label.error.not.allowed.create.from.template.same.folder", "No se permite crear un archivo en la carpeta origen");
	    ...
	    lang.put("tab.workspace.dashboard", "Tablero de mando");
	    ...
	    lang.put("mail.attachment", "Archivos adjuntos");
	    ...
	    lang.put("dashboard.tab.workflow", "Flujos");
	    ...
	    lang.put("dashboard.workflow.comments", "Comentarios");
	    ...
	    // Categories
	    lang.put("categories.folder.select.label", "Añadir una categoría");
	    ...
	    lang.put("OKM-"+ErrorCode.ORIGIN_OKMAuthService+ErrorCode.CAUSE_AccessDenied, "No tiene permisos para acceder al elemento");
	    lang.put("OKM-"+ErrorCode.ORIGIN_OKMAuthService+ErrorCode.CAUSE_ItemNotFound, "No existe un elemento con ese nombre");
	    lang.put("OKM-"+ErrorCode.ORIGIN_OKMAuthService+ErrorCode.CAUSE_Repository, "Error interno del repositorio");
	    lang.put("OKM-"+ErrorCode.ORIGIN_OKMAuthService+ErrorCode.CAUSE_General, "Error interno de la aplicación");
	    ...
	    lang.put("OKM-"+ErrorCode.ORIGIN_OKMUploadService+ErrorCode.CAUSE_UnsupportedMimeType, "Tipo de archivo no soportado");
