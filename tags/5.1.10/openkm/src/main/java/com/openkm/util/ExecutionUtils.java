...
public class ExecutionUtils {
	...
	private static int TIMEOUT = 5 * 60; // 5 * 60 seconds (5 minutes)
	...
	public static ExecutionResult runCmd(String cmd) throws SecurityException, InterruptedException, IOException {
		...
		return runCmdImpl(cmd.split(" "), TimeUnit.SECONDS.toMillis(TIMEOUT));
	}
	...
	public static ExecutionResult runCmd(String cmd[]) throws SecurityException, InterruptedException, IOException {
		...
		return runCmdImpl(cmd, TimeUnit.SECONDS.toMillis(TIMEOUT));
	}
