...
mvn install:install-file -DgroupId=com.google.gwt -DartifactId=gwt-incubator -Dversion=20091216-r1739 -Dpackaging=jar -Dfile=gwt-incubator-20091216-r1739.jar
