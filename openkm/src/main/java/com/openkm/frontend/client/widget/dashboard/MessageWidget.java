...
public class MessageWidget extends Composite {
	...
	private static final int TYPE_PENDING_MESSAGE 	= 1;
	private static final int TYPE_REVIEWED_MESSAGE 	= 2;
	...
	private int widgetType = TYPE_PENDING_MESSAGE;
	private GWTTaskInstance taskInstancePooled = null;
	
	/**
	 * MessageWidget
	 */
	public MessageWidget(String headerTextKey, String iconUrl, boolean zoom) {
		status = new Status();
	...
	public void setIsWidgetPendingTask() {
		widgetType = TYPE_PENDING_MESSAGE;
	}
	...
	public void setIsWidgetPooledTask() {
		widgetType = TYPE_REVIEWED_MESSAGE;
	}
