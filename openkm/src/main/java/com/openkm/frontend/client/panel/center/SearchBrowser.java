 ...
 *
 */
public class SearchBrowser extends ExtendedComposite {
	
	private final static int PANEL_TOP_HEIGHT 			= 240;
	private final static int PANEL_TOP_HEIGHT_ADVANCED 	= 325;
	...
	public void setSize(int width, int height) {
		...
		searchIn.setSize(""+(width-2), ""+(topHeight-2));
	...
	/**
	 * resizeToAdvancedView
	 * 
	 * @param enabled
	 */
	public void resizeToAdvancedView(boolean enabled) {
		if (enabled) {
			topHeight = PANEL_TOP_HEIGHT_ADVANCED;
		} else {
			topHeight = PANEL_TOP_HEIGHT;
		}
		bottomHeight = height - (topHeight + SPLITTER_HEIGHT);
