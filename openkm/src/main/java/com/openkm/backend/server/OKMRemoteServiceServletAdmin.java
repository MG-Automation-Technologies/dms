 ...
 *
 */
public class OKMRemoteServiceServletAdmin extends RemoteServiceServlet {
	private static Logger log = LoggerFactory.getLogger(OKMRemoteServiceServletAdmin.class);
	...
	public String getToken() throws OKMException {
		...
		if (token == null) {
			...
			throw new OKMException(ErrorCode.get(ErrorCode.ORIGIN_OKMRemoteServiceAdmin, ErrorCode.CAUSE_SessionLost), "Session lost");
		}
