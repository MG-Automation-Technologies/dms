...
public class OKMStatsServletAdmin extends OKMRemoteServiceServletAdmin implements OKMStatsService  {
	...
	/* (non-Javadoc)
	 * @see com.openkm.backend.client.service.OKMStatsService#getFoldersByContext()
	 */
	...
	/* (non-Javadoc)
	 * @see com.openkm.backend.client.service.OKMStatsService#getDocumentsByContext()
	 */
	...
	/* (non-Javadoc)
	 * @see com.openkm.backend.client.service.OKMStatsService#getContextSize()
	 */
