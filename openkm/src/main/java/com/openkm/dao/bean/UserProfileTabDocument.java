...
public class UserProfileTabDocument implements Serializable {
	...
	public String toString() {
		...
		sb.append(", versionsVisible="); sb.append(versionsVisible);
		sb.append(", previewVisible="); sb.append(previewVisible);
		sb.append(", propertyGroupsVisible="); sb.append(propertyGroupsVisible);
		sb.append("}");
		return sb.toString();
	}
}
