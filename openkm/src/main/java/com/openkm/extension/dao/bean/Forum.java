...
public class Forum implements Serializable {
	...
	public String toString() {
		...
		sb.append(", lastPostUser="); sb.append(lastPostUser);
		sb.append(", lastPostDate="); sb.append(lastPostDate);
		sb.append(", numTopics="); sb.append(numTopics);
		sb.append(", numPosts="); sb.append(numPosts);
		sb.append(", active="); sb.append(active);
		sb.append(", topics="); sb.append(topics);
		sb.append("}");
		return sb.toString();
	}
}
