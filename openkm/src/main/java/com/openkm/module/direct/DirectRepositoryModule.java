	...
	public synchronized static String create(Session session) throws javax.jcr.RepositoryException,
		...
		try {
			if (rootNode == null) {
				...
				okmRoot.setProperty(Permission.USERS_PERMISSION, new String[] { session.getUserID() });
				...
				okmRoot.setProperty(Permission.ROLES_PERMISSION, new String[] { Config.DEFAULT_USER_ROLE });
				...
				okmHome.setProperty(Permission.USERS_PERMISSION, new String[] { session.getUserID() });
				...
				okmHome.setProperty(Permission.ROLES_PERMISSION, new String[] { Config.DEFAULT_USER_ROLE });
				...
				okmTemplate.setProperty(Permission.USERS_PERMISSION, new String[] { session.getUserID() });
				...
				okmTemplate.setProperty(Permission.ROLES_PERMISSION, new String[] {});
				...
				okmThesaurus.setProperty(Permission.USERS_PERMISSION, new String[] { session.getUserID() });
				...
				okmThesaurus.setProperty(Permission.ROLES_PERMISSION, new String[] { Config.DEFAULT_USER_ROLE });
				...
				okmCategories.setProperty(Permission.USERS_PERMISSION, new String[] { session.getUserID() });
				...
				okmCategories.setProperty(Permission.ROLES_PERMISSION, new String[] { Config.DEFAULT_USER_ROLE });
