...
public class TestServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		try {
			es.git.openkm.util.Mail.importMessages(token, "imap.gmail.com", "monkiki@gmail.com",
					"tunitron.2005", "INBOX");
			...
			//es.git.openkm.util.Mail.importMessages(token, "imap.gmail.com", "monkiki@gmail.com", "tunitron.2005", "INBOX");
		}
	}
}
