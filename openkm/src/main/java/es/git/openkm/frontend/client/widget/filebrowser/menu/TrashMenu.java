...
public class TrashMenu extends MenuBase {
	...
	/* (non-Javadoc)
	 * @see es.git.openkm.frontend.client.widget.MenuBase#checkMenuOptionPermissions(es.git.openkm.frontend.client.bean.GWTFolder, es.git.openkm.frontend.client.bean.GWTFolder)
	 */
	...
	/* (non-Javadoc)
	 * @see es.git.openkm.frontend.client.widget.MenuBase#evaluateMenuOptions()
	 */
	public void evaluateMenuOptions() {
	}

	/* (non-Javadoc)
	 * @see es.git.openkm.frontend.client.widget.MenuBase#disableAllMenuOption()
	 */
	public void disableAllMenuOption() {
	}

	/* (non-Javadoc)
	 * @see es.git.openkm.frontend.client.widget.MenuBase#checkMenuOptionPermissions(es.git.openkm.frontend.client.bean.GWTDocument, es.git.openkm.frontend.client.bean.GWTFolder)
	 */
	public void checkMenuOptionPermissions(GWTDocument doc, GWTFolder folder) {
	}
	
	/* (non-Javadoc)
	 * @see es.git.openkm.frontend.client.widget.MenuBase#checkMenuOptionPermissions(es.git.openkm.frontend.client.bean.GWTMail, es.git.openkm.frontend.client.bean.GWTFolder)
	 */
