...
package es.git.openkm.frontend.client.panel.top;
...
import es.git.openkm.frontend.client.widget.TabWorkspace;
import es.git.openkm.frontend.client.widget.ToolBar;
