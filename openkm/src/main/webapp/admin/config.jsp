...
%>
	...
	<table class="results" align="center">
		...
		<tr class="even"><td><b><%=Config.PROPERTY_NOTIFY_MESSAGE_SUBJECT %></b></td><td><%=escape(Config.NOTIFY_MESSAGE_SUBJECT) %></td></tr>
		<tr class="odd"><td><b><%=Config.PROPERTY_NOTIFY_MESSAGE_BODY %></b></td><td><%=escape(Config.NOTIFY_MESSAGE_BODY) %></td></tr>
