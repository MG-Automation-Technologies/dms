          ...
          <tr>
            ...
            <td>
              <c:url value="RepositorySearch" var="urlPreLocked">
                ...
                <c:param name="statement" value="/jcr:root/okm:root//element(*,okm:document)[@jcr:lockOwner]/@jcr:lockOwner"/>
              </c:url>
              <c:url value="RepositorySearch" var="urlPreCreated">
                <c:param name="type" value="xpath"/>
                <c:param name="statement" value="/jcr:root/okm:root//element(*, okm:document)[@okm:author='okmAdmin']/(@jcr:lockOwner|@jcr:created)"/>
              </c:url>
              <c:url value="RepositorySearch" var="urlPreProperty">
                <c:param name="type" value="xpath"/>
                <c:param name="statement" value="/jcr:root/okm:root//element(*, okg:test)"/>
              </c:url>
              <c:url value="RepositorySearch" var="urlPreSubscription">
                <c:param name="type" value="xpath"/>
                <c:param name="statement" value="/jcr:root/okm:root//element(*, mix:notification)/@okm:subscriptors"/>
              </c:url>
