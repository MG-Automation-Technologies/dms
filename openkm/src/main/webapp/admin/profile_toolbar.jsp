...
<fieldset>
  ...
  <table>
    <tr>
      ...
      <td>
        <c:choose>
          <c:when test="${prf.toolbar.createFolderVisible}">
    ...
    <tr>
      ...
      <td>
        <c:choose>
          <c:when test="${prf.toolbar.findFolderVisible}">
    ...
    <tr>
      ...
      <td>
        <c:choose>
          <c:when test="${prf.toolbar.findDocumentVisible}">
    ...
    <tr>
      ...
      <td>
        <c:choose>
          <c:when test="${prf.toolbar.downloadVisible}">
    ...
    <tr>
      ...
      <td>
        <c:choose>
          <c:when test="${prf.toolbar.downloadPdfVisible}">
    ...
    <tr>
      ...
      <td>
        <c:choose>
          <c:when test="${prf.toolbar.printVisible}">
    ...
    <tr>
      ...
      <td>
        <c:choose>
          <c:when test="${prf.toolbar.lockVisible}">
    ...
    <tr>
      ...
      <td>
        <c:choose>
          <c:when test="${prf.toolbar.unlockVisible}">
    ...
    <tr>
      ...
      <td>
        <c:choose>
          <c:when test="${prf.toolbar.addDocumentVisible}">
    ...
    <tr>
      ...
      <td>
        <c:choose>
          <c:when test="${prf.toolbar.checkoutVisible}">
    ...
    <tr>
      ...
      <td>
        <c:choose>
          <c:when test="${prf.toolbar.checkinVisible}">
    ...
    <tr>
      ...
      <td>
        <c:choose>
          <c:when test="${prf.toolbar.cancelCheckoutVisible}">
    ...
    <tr>
      ...
      <td>
        <c:choose>
          <c:when test="${prf.toolbar.deleteVisible}">
    ...
    <tr>
      ...
      <td>
        <c:choose>
          <c:when test="${prf.toolbar.addPropertyGroupVisible}">
    ...
    <tr>
      ...
      <td>
        <c:choose>
          <c:when test="${prf.toolbar.removePropertyGroupVisible}">
    ...
    <tr>
      ...
      <td>
        <c:choose>
          <c:when test="${prf.toolbar.startWorkflowVisible}">
    ...
    <tr>
      ...
      <td>
        <c:choose>
          <c:when test="${prf.toolbar.addSubscriptionVisible}">
    ...
    <tr>
      ...
      <td>
        <c:choose>
          <c:when test="${prf.toolbar.removeSubscriptionVisible}">
    ...
    <tr>
      ...
      <td>
        <c:choose>
          <c:when test="${prf.toolbar.refreshVisible}">
    ...
    <tr>
      ...
      <td>
        <c:choose>
          <c:when test="${prf.toolbar.homeVisible}">
    ...
    <tr>
      ...
      <td>
        <c:choose>
          <c:when test="${prf.toolbar.scannerVisible}">
    ...
    <tr>
      ...
      <td>
        <c:choose>
          <c:when test="${prf.toolbar.uploaderVisible}">
