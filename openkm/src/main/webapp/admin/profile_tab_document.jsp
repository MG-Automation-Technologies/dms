...
<fieldset>
  ...
  <table>
    <tr>
      ...
      <td>
        <c:choose>
          <c:when test="${up.tab.document.propertiesVisible}">
    ...
    <tr>
      ...
      <td>
        <c:choose>
          <c:when test="${up.tab.document.securityVisible}">
    ...
    <tr>
      ...
      <td>
        <c:choose>
          <c:when test="${up.tab.document.notesVisible}">
    ...
    <tr>
      ...
      <td>
        <c:choose>
          <c:when test="${up.tab.document.versionsVisible}">
    ...
    <tr>
      ...
      <td>
        <c:choose>
          <c:when test="${up.tab.document.previewVisible}">
    ...
    <tr>
      ...
      <td>
        <c:choose>
          <c:when test="${up.tab.document.propertyGroupsVisible}">
